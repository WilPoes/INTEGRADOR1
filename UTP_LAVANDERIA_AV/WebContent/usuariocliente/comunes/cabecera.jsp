				...
				<nav class="navbar-nav mr-auto">
					<i class="w3-dark-grey w3-hover-light-green fa fa-home w3-xlarge"
						...
						<form
							...
							method="POST">
							<input class="w3-amber fa fa-home w3-round-large" type="submit"
								name="accion" value="Home"
								style="font-size: 11px; margin-top: 13px;">
						</form>
					</i> <i
						class="w3-dark-grey w3-hover-light-green fa fa-shopping-basket w3-xlarge"
						style="line-height: 1px; color: green; border: 1px solid green; border-radius: 20px; width: 110px; padding-top: 24px;">
						<form
							action="${pageContext.request.contextPath}/ServletPedido?accion=listarserviciocategoria"
							method="POST">
							<input class="w3-amber fa fa-shopping-basket w3-round-large"
